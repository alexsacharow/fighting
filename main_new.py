...
# Load background
bg_image = pygame.image.load("assets/pic/bg/bg_test.png").convert_alpha()
...
while IS_RUNNING:
    ...
    if round_over == False:
        ...
        # Display win text
        draw_text(
            "Player {} Wins!".format(1 if fighter_1.alive else 2),
            victory_font,
            RED,
            SCREEN_WIDTH / 3.5,
            SCREEN_HEIGHT / 5,
        ...
        if pygame.time.get_ticks() - round_over_time > ROUND_OVER_COOLDOWN:
            ...
            fighter_1 = Fighter(
                1, 200, 370, False, HERO1_DATA, hero1_sheet, HERO1_ANIMATION_FRAMES, sword_fx, hit_fx
            )
            fighter_2 = Fighter(
                2, 700, 370, True, HERO2_DATA, hero2_sheet, HERO2_ANIMATION_FRAMES, sword_fx, hit_fx
            )
